            ...
            <table class="table table-bordered">
              <form action="/product/store" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="url" required="required" placeholder="">
                </div>
                <div class="form-group">
                    <label for="">Category Name</label>
                    <input type="text" class="form-control" name="category_name" required="required" placeholder="">
                </div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="price" required="required" placeholder="">
                 </div>
                 <div class="form-group">

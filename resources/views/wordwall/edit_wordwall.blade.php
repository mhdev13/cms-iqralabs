                ...
                <div class="card-body">
                  ...
                  <input type="hidden" name="id" value="{{ $wordwall['id'] }}"> <br/>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="category" value="{{ $wordwall['category'] }}" required="required">
                  </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="status" name="status" required="required">
                        <option value="Published" {{ $wordwall['status'] == "Published" ? 'selected' : ''}}>Published</option>
                        <option value="Draft" {{ $wordwall['status'] == "Draft" ? 'selected' : ''}}>Draft</option>
                      </select>
                    </div>
                    <br>
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="col-md-12">
                          <img src="/images/{{ $wordwall['image_thumbnail'] }}" id="image_thumbnail" name="image_thumbnail" height="100" width="100">
                        </div>
                        <br>
                        <br>
                        <br>
                        ...
                        <div class="custom-file">
                          ...
                          <input type="hidden" name="image_thumbnail" value="{{ $wordwall['image_thumbnail'] }}" /> 
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="thumbnail" name="thumbnail" required="required">
                        <option value="Active" {{ $wordwall['thumbnail'] == "Active" ? 'selected' : ''}}>Active</option>
                        <option value="Inactive" {{ $wordwall['thumbnail'] == "Inactive" ? 'selected' : ''}}>Inactive</option>
                      </select>
                    </div>
                    <div class="form-group">
